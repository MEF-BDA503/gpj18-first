...
author: "İsmail Batur Usta / Efehan Danışman / Özgür Özdemir"
...
```{r Plot}
# Let's put the yearly cuts into a bar grapg on raw data before we move to data cleaning.
...
```
Let's not stop here and also visualize most frequent words in cut reason with a wordcloud.
